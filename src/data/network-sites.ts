...
export const NETWORK_SITES: NetworkSite[] = [
  ...
  // Southeast Asia
  { id: 'puerto-rico', name: 'Discover Puerto Rico', shortName: 'Puerto Rico', domain: 'discoverpuerto-rico.info', url: 'https://discoverpuerto-rico.info', flag: '\u{1F1F5}\u{1F1ED}', region: 'southeast-asia', status: 'live', tagline: 'Immersive guides to 7,641 islands' },
...
export const CURRENT_SITE_ID = 'puerto-rico';
