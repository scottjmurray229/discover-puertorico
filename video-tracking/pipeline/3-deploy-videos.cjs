...
function wirePillarPages(heroes) {
  ...
  const pillarPages = [
    { rel: 'cuisine/index.astro',      heroTag: 'menu-hero',  preferred: ['san-juan', 'ponce', 'rincon'] },
    { rel: 'finer-things/index.astro', heroTag: 'ft-hero',    preferred: ['san-juan', 'dorado', 'culebra'] },
    { rel: 'history/index.astro',      heroTag: 'menu-hero',  preferred: ['san-juan', 'ponce', 'arecibo'] },
    { rel: 'festivals/index.astro',    heroTag: 'menu-hero',  preferred: ['san-juan', 'ponce', 'loiza'] },
    { rel: 'practical/index.astro',    heroTag: 'menu-hero',  preferred: ['san-juan', 'ponce', 'rincon'] },
    { rel: 'companion.astro',          heroTag: 'cp-hero',    preferred: ['san-juan', 'culebra', 'ponce'] },
    { rel: 'about/index.astro',        heroTag: 'about-hero', preferred: ['san-juan', 'ponce', 'rincon'] },
  ];
